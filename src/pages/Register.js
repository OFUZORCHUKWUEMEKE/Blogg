          ...
          <Grid container spacing={3} justifyContent='space-between' alignItems='center'>
            <Grid item xs={12} md={6}>
              ...
              <form onSubmit={handleSubmit}>
                <Stack spacing={3}>
                  <input className='py-3 px-4 outline-none border-0 rounded-md bg-[#0a0e14] text-white' type='username' placeholder='username' name='username' onChange={onChange} />
                  <input className='py-3 px-4 outline-none border-0 rounded-md bg-[#0a0e14] text-white' type='email' placeholder='email' name='email' onChange={onChange} />
                  <input className='py-3 px-4 outline-none border-0 rounded-md bg-[#0a0e14] text-white' type='password' placeholder='password' onChange={onChange} name='password' />
                  <input className='py-3 px-4 outline-none border-0 rounded-md bg-[#0a0e14] text-white' type='password' placeholder='confirmpassword' onChange={onChange} name='conFirmPassword' />
